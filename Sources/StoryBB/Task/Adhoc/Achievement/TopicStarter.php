...
class TopicStarter extends \StoryBB\Task\Adhoc
{
	...
	public function execute()
	{
		...
		Achievement::trigger_award_achievement('account_topic_starter', $account, $character);
		Achievement::trigger_award_achievement('character_topic_starter', $account, $character);
		Achievement::trigger_award_achievement('topic_starter', $account, $character);
